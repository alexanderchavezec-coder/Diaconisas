...
import { Home, Users, UserPlus, Calendar, FileText, LogOut, BarChart3 } from 'lucide-react';
...
export default function Layout({ onLogout }) {
  ...
  const menuItems = [
    ...
    { path: '/statistics', icon: BarChart3, label: 'Estadísticas', testId: 'nav-statistics' },
  ];
      ...
      <aside className="w-64 bg-gradient-to-b from-blue-600 to-purple-700 text-white flex flex-col shadow-2xl">
        <div className="p-6 border-b border-white/20">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-lg font-bold text-white">Departamento de</p>
              <p className="text-lg font-bold text-white">Diaconisas</p>
            </div>
          </div>
        </div>
